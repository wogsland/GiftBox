...
<section class="profile" id="account-profile">
	<div class="contentpanel">
		<div class="row">
            ...
            <h4 class="profile-name mb5">User You</h4>
            <div class="small-txt mb5"><i class="fa fa-gift"></i> X Tokens</div>
            <div class="small-txt mb5"><i class="fa fa-star"></i> XXYYZZ Token Views</div>
            <div class="small-txt mb5"><i class="fa fa-map-marker"></i> City, State, Country</div>
				...
				<!-- Activities -->
		      	<div class="tab-pane active" id="activities">
			      	<h2>Activities</h2>
				        ...
				        <li>
				          <div class="timeline-badge solid-green"><i class="fa fa-gift"></i></div>
				          <div class="timeline-panel">
				            <div class="timeline-heading">
				              <h4 class="timeline-title">Mussum ipsum cacilds</h4>
				            </div>
				        ...
				        <li>
				          <div class="timeline-badge solid-lt-blue"><i class="fa fa-picture-o"></i></div>
				          <div class="timeline-panel">
				            <div class="timeline-heading">
				              <h4 class="timeline-title">Mussum ipsum cacilds</h4>
				            </div>
		      	...
		      	<div class="tab-pane" id="givetokens">
			      	...
			      	<div class="col-md-3 col-xs-6 text-center"><img src="assets/img/token-varied-04.png" alt="" width="79" height="66"><br><div class="main-color">GiveToken 4</div>For: Angela L.</div>
		      	</div>
		      	<!-- Messages -->
              ...
              <div class="row">
                  ...
                  <div class="col-sm-9 col-md-9 col-lg-10">
                      ...
                      <div class="msg-header">
                          ...
                          <div class="pull-left">
                              <button class="btn btn-white tooltips" type="button" data-toggle="tooltip" title="" data-original-title="Archive"><i class="fa fa-hdd-o"></i></button>
                              <button class="btn btn-white tooltips" type="button" data-toggle="tooltip" title="" data-original-title="Report Spam"><i class="fa fa-exclamation-circle"></i></button>
                              <button class="btn btn-white tooltips" type="button" data-toggle="tooltip" title="" data-original-title="Delete"><i class="fa fa-trash-o"></i></button>                                
                              
                              <div class="btn-group">
                                  <button data-toggle="dropdown" class="btn btn-white dropdown-toggle tooltips" type="button" title="" data-original-title="Move to Folder">
                              ...
                              <div class="btn-group">
                                  <button data-toggle="dropdown" class="btn btn-white dropdown-toggle tooltips" type="button" title="" data-original-title="Label">
                                      <i class="fa fa-tag"></i>
                                  </button>
                                  <ul class="dropdown-menu pull-right">
                      ...
                      <ul class="media-list msg-list">
                          <li class="media unread">
                              ...
                              <a class="pull-left" href="#">
                                  <img class="media-object img-circle img-online" src="assets/img/user1.png" alt="...">
                              </a>
                              <div class="media-body">
                                  ...
                                  <h4 class="sender">Jimmy Graham</h4>
                                  <p><a href="#"><strong class="subject">Hi Hello!</strong> Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt...</a></p>
                              </div>
                          </li>
                          <li class="media unread">
                              <div class="ckbox ckbox-primary pull-left">
                              ...
                              <a class="pull-left" href="#">
                                  <img class="media-object img-circle img-offline" src="assets/img/user2.png" alt="...">
                              </a>
                              <div class="media-body">
                                  <div class="pull-right media-option">
                                  ...
                                  <h4 class="sender">Tony Romo</h4>
                                  <p><a href="#"><strong class="subject">Weekly Recognition Reminder</strong> Consectetur adipisicing elit, sed do eiusmod tempor incididunt...</a></p>
                              </div>
                          </li>
                          <li class="media">
                              <div class="ckbox ckbox-primary pull-left">
                              ...
                              <a class="pull-left" href="#">
                                  <img class="media-object img-circle img-online" src="assets/img/user3.png" alt="...">
                              </a>
                              <div class="media-body">
                                  <div class="pull-right media-option">
                                      <i class="fa fa-paperclip mr5"></i>
                                  ...
                                  <h4 class="sender">Jimmy Clausen</h4>
                                  <p><a href="#"><strong class="subject">Weno added you as a friend</strong> Consectetur adipisicing elit, sed do eiusmod tempor incididunt...</a></p>
                              </div>
                          </li>
                          <li class="media">
                              <div class="ckbox ckbox-primary pull-left">
                              ...
                              <a class="pull-left" href="#">
                                  <img class="media-object img-circle img-online" src="assets/img/user4.png" alt="...">
                              </a>
                              <div class="media-body">
                                  <div class="pull-right media-option">
                                      <i class="fa fa-paperclip mr5"></i>
                                  ...
                                  <h4 class="sender">Steve Smith</h4>
                                  <p><a href="#"><strong class="subject">Mobile Banking Transaction</strong> Consectetur adipisicing elit, sed do eiusmod tempor incididunt...</a></p>
                              </div>
                          </li>
                          <li class="media">
                              <div class="ckbox ckbox-primary pull-left">
                              ...
                              <a class="pull-left" href="#">
                                  <img class="media-object img-circle img-offline" src="assets/img/user5.png" alt="...">
                              </a>
                              <div class="media-body">
                                  <div class="pull-right media-option">
                                  ...
                                  <h4 class="sender">Eli Manning</h4>
                                  <p><a href="#"><strong class="subject">Brown Bag Reminder</strong> Sed do eiusmod tempor incididunt consectetur adipisicing elit, sed do...</a></p>
                              </div>
                          </li>
                          <li class="media">
                              <div class="ckbox ckbox-primary pull-left">
                          ...
                          <li class="media">
                              ...
                              <a class="pull-left" href="#">
                                  <img class="media-object img-circle img-offline" src="assets/img/user3.png" alt="...">
                              </a>
                              <div class="media-body">
                                  <div class="pull-right media-option">
                          ...
                          <li class="media">
                              ...
                              <a class="pull-left" href="#">
                                  <img class="media-object img-circle img-offline" src="assets/img/user4.png" alt="...">
                              </a>
                              <div class="media-body">
                                  <div class="pull-right media-option">
                          ...
                          <li class="media">
                              ...
                              <a class="pull-left" href="#">
                                  <img class="media-object img-circle img-online" src="assets/img/user5.png" alt="...">
                              </a>
                              <div class="media-body">
                                  <div class="pull-right media-option">
		      	...
		      	<div class="tab-pane" id="viewers">
			      	...
			      	<div class="form-group">
								<div class="checkbox block"><label><input type="checkbox"> Administration</label></div>
								<div class="checkbox block"><label><input type="checkbox"> Employees</label></div>
								<div class="checkbox block"><label><input type="checkbox"> Alumni</label></div>
								<div class="checkbox block"><label><input type="checkbox"> Donors</label></div>
							</div>
              <hr>
			      	<div class="row">
			        ...
			        <div class="table-responsive">
								...
								<ul class="pagination pagination-split pagination-circled nomargin pull-right">
                    ...
                    <li><a href="#"><i class="fa fa-angle-right"></i></a></li>
			      	...
			      	<div class="modal fade" id="edit" tabindex="-1" role="dialog" aria-labelledby="edit" aria-hidden="true">
								...
								<div class="modal-body">
									<div class="form-group"><input class="form-control" type="text" placeholder="John"></div>
									<div class="form-group"><input class="form-control" type="text" placeholder="Smith"></div>
									<div class="form-group"><input class="form-control" type="text" placeholder="username@yourdomain.com"></div>
								...
								<button type="button" class="btn btn-lg standard-button2" style="width: 100%;">
		      	...
		      	<div class="tab-pane" id="account">
			      	...
			      	<form class="form-horizontal form-bordered">
				      	<div class="form-group">
	                        ...
	                        <div class="col-sm-10">
	                            <input type="text" placeholder="Tom Brady" title="" class="form-control tooltips">
	                        </div>
	                        <label class="col-sm-1 control-label"><a href="#" target="" class="">Edit</a></label>
	                    </div>
				      	<div class="form-group">
	                        <label class="col-sm-1 control-label">Usernam</label>
	                        <div class="col-sm-10">
	                            <input type="text" placeholder="tbrady12" title="" class="form-control tooltips">
	                        </div>
	                        <label class="col-sm-1 control-label"><a href="#" target="" class="">Edit</a></label>
	                    </div>
				      	<div class="form-group">
	                        ...
	                        <div class="col-sm-10">
	                            <input type="text" placeholder="tbrady@yourdomain.com" title="" class="form-control tooltips">
	                        </div>
	                        <label class="col-sm-1 control-label"><a href="#" target="" class="">Edit</a></label>
	                    </div>
				      	<div class="form-group">
	                        ...
	                        <div class="col-sm-10">
	                            <input type="password" placeholder="*******" title="" class="form-control tooltips">
	                        </div>
	                        <label class="col-sm-1 control-label"><a href="#" target="" class="">Edit</a></label>
	                    </div>
				      	<div class="form-group">
	                        <label class="col-sm-1 control-label">Networks</label>
	                        <div class="col-sm-10">
			      	...
			      	<form class="form-horizontal form-bordered">
				      	<div class="form-group">
	                        <label class="col-sm-1 control-label">CC Number</label>
	                        <div class="col-sm-10">
	                            <input type="text" placeholder="**** **** **** 5678" title="" class="form-control tooltips">
	                        </div>
	                        <label class="col-sm-1 control-label"><a href="#" target="" class="">Edit</a></label>
	                    </div>
				      	<div class="form-group">
	                        <label class="col-sm-1 control-label">CCV</label>
	                        <div class="col-sm-10">
	                            <input type="text" placeholder="***" title="" class="form-control tooltips">
	                        </div>
	                        <label class="col-sm-1 control-label"><a href="#" target="" class="">Edit</a></label>
	                    </div>
	                    <!--
		      	...
		      	<div class="tab-pane" id="users">
			        ...
			        <div class="table-responsive">
			      	...
			      	<div class="modal fade" id="edit" tabindex="-1" role="dialog" aria-labelledby="edit" aria-hidden="true">
								...
								<input class="form-control " type="text" placeholder="jsmith25">
								</div>
								<div class="form-group">
