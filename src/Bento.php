...
class Bento
{
    ...
    public $cropped_image_file_name;
    public $image_width;
    public $image_height;
    public $image_top;
    public $image_left;
    public $download_file_name;
    public $download_mime_type;
    public $content_uri;
    public $slider_value;
    public $image_left_in_container;
    public $image_top_in_container;
    public $image_hyperlink;
    public $bento_file_list = array();
    public $redirect_url;
    public $auto_play;
    public $overlay_content;
    public $overlay_left;
    public $overlay_top;
    public $button_type;
    public $button_title;
