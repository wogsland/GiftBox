...
function submitInterest(t){var e=0,a=[];if(openedInterestPopup=!1,enableBackButton(),void 0!==t.path)a=t.path,$(a[8]).is("location-x-card")?e=1:$(a[5]).is("image-x-card")?e=2:$(a[5]).is("video-x-card")?e=3:$(a[5]).is("description-x-card")&&(e=4);else{for(var i=t.target;i;)a.push(i),i=i.parentElement;-1===a.indexOf(window)&&-1===a.indexOf(document)&&a.push(document),-1===a.indexOf(window)&&a.push(window),"location-x-card"==a[8].localName?e=1:"image-x-card"==a[5].localName?e=2:"video-x-card"==a[5].localName?e=3:"description-x-card"==a[5].localName&&(e=4)}if(t.preventDefault(),$(".email-paper-input")[e].validate()){$(".submit-interest-button").addClass("disable-clicks");var o=$("#interest-response")[0].selectedItem.value;url="/ajax/recruiting_token_response/create"+path[4],url+="/"+encodeURIComponent($(".email-paper-input")[e].value),url+="/"+o,$(".name-paper-input").length&&(url+="/"+encodeURIComponent($(".name-paper-input")[e].value)),$.post(url,"",function(t){void 0!==t.data.id&t.data.id>0?("yes"==o||"maybe"==o?""!==applicationLink?window.location.href=applicationLink:($(".interest-form").text("Thanks for you interest!"),$(".submit-interest-button").remove(),$(".dismiss-interest-button").text("DISMISS")):($(".interest-form").text("Thanks for telling us!"),$(".submit-interest-button").remove(),$(".dismiss-interest-button").text("DISMISS")),$(".interest-fab").remove()):$(".submit-interest-button").removeClass("disable-clicks")},"json")}}function closeInterestDialog(){$(document).not(".interest-fab").click(function(){$(".interest-dialog").each(function(t,e){e.close(),$(this).remove()})})}function disableBackButton(){$(".back-button").addClass("mdl-button--disabled"),$(".back-button-lower").addClass("mdl-button--disabled"),$(".back-button-lower-right").addClass("mdl-button--disabled")}function enableBackButton(){$(".back-button").removeClass("mdl-button--disabled"),$(".back-button-lower").removeClass("mdl-button--disabled"),$(".back-button-lower-right").removeClass("mdl-button--disabled")}function loadDataAndPopulateToken(){path=getUrlPath(),"/token"===path[2]&"/recruiting"==path[3]&"undefined"!=typeof path[4]?(url="/ajax/recruiting_token/get"+path[4],$.post(url,"",handleAjaxRecruitingTokenGet,"json"),url="/ajax/recruiting_token/get_images"+path[4],$.post(url,"",function(t){void 0!==t.data&&t.data.length>0?(assetHost=getAssetHost(),t.data.length>0?($("#images-frontpage").hide(),$("#company-image-grid").css("width","100%"),$("#company-main-image").css("background","url('"+assetHost+"/"+t.data[0].file_name+"') center / cover"),$(window).width()<739||t.data.length<4?($("#company-secondary-images").remove(),$("#company-main-image").css("width","100%")):($("#company-secondary-image-1").attr("src",assetHost+"/"+t.data[1].file_name),$("#company-secondary-image-1").parent().css("width","100%"),$("#company-secondary-image-2").attr("src",assetHost+"/"+t.data[2].file_name),$("#company-secondary-image-2").parent().css("width","100%"),$("#company-secondary-image-3").attr("src",assetHost+"/"+t.data[3].file_name),$("#company-secondary-image-3").parent().css("width","100%")),$("#videos-frontpage").removeClass("mdl-cell--6-col"),$("#videos-frontpage").addClass("mdl-cell--12-col")):($("#company-section").hide(),$("#images-frontpage").css("background","url('"+assetHost+"/"+t.data[0].file_name+"') center / cover"))):($("#company-section").hide(),$("#images-frontpage").hide(),$("#videos-frontpage").removeClass("mdl-cell--6-col"),$("#videos-frontpage").addClass("mdl-cell--12-col"))}),url="/ajax/recruiting_token/get_responses_allowed"+path[4],$.post(url,"",handleAjaxRecruitingTokenGetResponsedAllowed,"json"),$.post("/ajax/recruiting_token/get_apply_link"+path[4],"",function(t){void 0!==t.data&&(applicationLink=t.data),""!==applicationLink&&($(".submit-interest-button").remove(),$(".apply-button").removeAttr("hidden"),$(".apply-button").text("APPLY"),$(".apply-button").removeClass("apply-button"))},"json"),url="/ajax/recruiting_token/get_videos"+path[4],$.post(url,"",function(t){if(void 0!==t.data&&t.data.length>0){var e=t.data[0].source_id;"youtube"==t.data[0].source&&(vidUrl="https://i.ytimg.com/vi/"+e+"/hqdefault.jpg",$("#videos-frontpage").css("background","url('"+vidUrl+"') center / cover")),"vimeo"==t.data[0].source&&$.getJSON("https://vimeo.com/api/v2/video/"+e+".json",function(t){$("#videos-frontpage").css("background","url('"+t[0].thumbnail_large+"') center / cover")})}else $(window).width()<739&&($("#location-secondary-images").remove(),$("#location-main-image").css("width","100%")),$("#videos-frontpage").hide(),$("#images-frontpage").removeClass("mdl-cell--6-col"),$("#images-frontpage").addClass("mdl-cell--12-col")})):window.location.href="https://www.gosizzle.io",smallScreen()}function smallScreen(){$(window).width()<739&&($(".back-button-lower").addClass("back-button-lower-right"),$(".back-button-lower-right").removeClass("back-button-lower"))}function numberWithCommas(t){return t.toString().replace(/\B(?=(\d{3})+(?!\d))/g,",")}function dataExists(t){return void 0!==t&&null!==t&&""!==t}function getUrlPath(){var t={};i=0;window.location.href.replace(/\/([a-zA-Z0-9]*)/gi,function(e){t[i]=e,i++});return t}function getAssetHost(){switch(window.location.hostname){default:return"/uploads"}}function getPosition(t,e,a){return t.split(e,a).join(e).length}function handleAjaxCityGet(t){if(void 0!==t.id&t.id>0){$(".gt-info-location").text(t.name),dataExists(t.population)&&$(".gt-city-population").text(numberWithCommas(t.population)),$(".gt-city-timezone").text(t.timezone),$(".gt-city-county").text(t.county),$("google-map")[0].latitude=t.latitude,$("google-map")[0].longitude=t.longitude;var e=!1;dataExists(t.temp_hi_spring)?$(".gt-city-spring-hi").text(t.temp_hi_spring):e=!0,dataExists(t.temp_lo_spring)?$(".gt-city-spring-lo").text(t.temp_lo_spring):e=!0,dataExists(t.temp_avg_spring)?$(".gt-city-spring-avg").text(t.temp_avg_spring):e=!0,dataExists(t.temp_hi_summer)?$(".gt-city-summer-hi").text(t.temp_hi_summer):e=!0,dataExists(t.temp_lo_summer)?$(".gt-city-summer-lo").text(t.temp_lo_summer):e=!0,dataExists(t.temp_avg_summer)?$(".gt-city-summer-avg").text(t.temp_avg_summer):e=!0,dataExists(t.temp_hi_fall)?$(".gt-city-fall-hi").text(t.temp_hi_fall):e=!0,dataExists(t.temp_lo_fall)?$(".gt-city-fall-lo").text(t.temp_lo_fall):e=!0,dataExists(t.temp_avg_fall)?$(".gt-city-fall-avg").text(t.temp_avg_fall):e=!0,dataExists(t.temp_hi_winter)?$(".gt-city-winter-hi").text(t.temp_hi_winter):e=!0,dataExists(t.temp_lo_winter)?$(".gt-city-winter-lo").text(t.temp_lo_winter):e=!0,dataExists(t.temp_avg_winter)?$(".gt-city-winter-avg").text(t.temp_avg_winter):e=!0,e&&($("#spring-location").remove(),$("#summer-location").remove(),$("#fall-location").remove(),$("#winter-location").remove()),assetHost=getAssetHost(),url="/ajax/city/get_images",postData={city_id:t.id},$.post(url,postData,function(t){void 0!==t.data&&t.data.length>0&&(image_file=t.data[0],$("#location-back").css("background","url('"+image_file+"') center / cover"),$("#location-main-image").css("background","#ffffff url('"+image_file+"') center / cover"),$("#location-image-grid").css("width","100%"),t.data.length<4?($("#location-secondary-images").remove(),$("#location-main-image").css("width","100%")):($("#location-secondary-image-1").attr("src",t.data[1]),$("#location-secondary-image-1").parent().css("width","100%"),$("#location-secondary-image-2").attr("src",t.data[2]),$("#location-secondary-image-2").parent().css("width","100%"),$("#location-secondary-image-3").attr("src",t.data[3]),$("#location-secondary-image-3").parent().css("width","100%")))})}}function handleAjaxUserGetRecruiterProfile(t){void 0!==t.data?(assetHost=getAssetHost(),dataExists(t.data.face_image)&&($("#icon-or-face").remove(),$("#recruiter-face").css("background",'url("'+assetHost+"/"+t.data.face_image+'") 50% 50% / cover')),dataExists(t.data.position)?$("#gt-info-recruiter-position").html(t.data.position):$("#gt-info-recruiter-position").remove(),dataExists(t.data.about)?$("#gt-info-recruiter-bio").html(t.data.about):$("#gt-info-recruiter-bio").remove(),dataExists(t.data.linkedin)?($("#linkedin-button").attr("href",t.data.linkedin),$(".recruiter-profile-option").removeClass("mdl-cell--3-col"),$(".recruiter-profile-option").addClass("mdl-cell--12-col")):$("#linkedin-button").remove(),dataExists(t.data.first_name)||dataExists(t.data.last_name)?$("#gt-info-recruiter-name").html(t.data.first_name+" "+t.data.last_name):$("#recruiter-section").remove()):$("#recruiter-section").remove(),updateSectionPositions()}function handleAjaxRecruitingTokenGet(t){"false"==t.success&&(window.location.href="https://www.gosizzle.io");var e;dataExists(t.data.company)?($(".gt-info-company").text(t.data.company),t.data.company.length>36&&$(window).width()>800?($("#supporting-company").css("height","100px"),$("#supporting-company").css("margin-top","217px")):t.data.company.length>18&&$(window).width()<=800&&(t.data.company.length>36?($("#supporting-company").css("height","150px"),$("#supporting-company").css("margin-top","167px")):($("#supporting-company").css("height","100px"),$("#supporting-company").css("margin-top","217px"))),e=t.data.company+" - "+t.data.job_title):e=t.data.job_title,$("title").text(e),$(".gt-info-jobtitle").text(t.data.job_title),$(".gt-info-overview").html(t.data.job_description);var a=""+t.data.job_description,o=a.split(" "),n="";for(i=0;i<50;i++)void 0!==o[i]&&(n+=o[i]+" ");var s=(n.match(/<p>/g)||[]).length;s>4&&(n=n.substring(0,getPosition(n,"<p>",5))),(o.length>=50||s>4)&&(n+=" ... ",n+='<a href="#overview-section" id="read-more" class="mdl-color-text--primary-dark">read more</a>'),$(".gt-info-overview-short").html(n),dataExists(t.data.job_description)||$("#overview-section-2").hide();var l=0;if(dataExists(t.data.skills_required)?($(".gt-info-skills").html(t.data.skills_required),l++):($("#skills-button").hide(),$("#skills-section").hide(),$("#skills-section-2").hide()),dataExists(t.data.responsibilities)?($(".gt-info-responsibilities").html(t.data.responsibilities),l++):($("#responsibilities-button").hide(),$("#responsibilities-section").hide(),$("#responsibilities-section-2").hide()),dataExists(t.data.company_values)?($(".gt-info-values").html(t.data.company_values),l++):($("#values-button").hide(),$("#values-section").hide(),$("#values-section-2").hide()),dataExists(t.data.perks)?($(".gt-info-perks").html(t.data.perks),l++):($("#perks-button").hide(),$("#perks-section").hide(),$("#perks-section-2").hide()),dataExists(t.data.company_description)?$("#company-description-text").html(t.data.company_description):$("#company-description").hide(),4>l)switch(l){case 3:$(".job-description-option").removeClass("mdl-cell--3-col"),$(".job-description-option").addClass("mdl-cell--4-col");break;case 2:$(".job-description-option").removeClass("mdl-cell--3-col"),$(".job-description-option").addClass("mdl-cell--6-col");break;case 1:$(".job-description-option").removeClass("mdl-cell--3-col"),$(".job-description-option").addClass("mdl-cell--12-col")}dataExists(t.data.long_id)?(url="/ajax/recruiting_token/get_cities/"+t.data.long_id,$.post(url,"",function(t){if(cities=t.data,1==cities.length)handleAjaxCityGet(cities[0]),$("#doublet-location-section").remove(),$("#triplet-location-section").remove();else if(2==cities.length)$("#location-section").remove(),$("#triplet-location-section").remove(),$(".gt-info-location-1").text(cities[0].name),url="/ajax/city/get_images",postData={city_id:cities[0].id},$.post(url,postData,function(t){void 0!==t.data&&t.data.length>0&&(image_file=t.data[0],$("#doublet-location-main-image-1").css("background","url('"+image_file+"') center / cover"))}),$(".gt-info-location-2").text(cities[1].name),url="/ajax/city/get_images",postData={city_id:cities[1].id},$.post(url,postData,function(t){void 0!==t.data&&t.data.length>0&&(image_file=t.data[0],$("#doublet-location-main-image-2").css("background","url('"+image_file+"') center / cover"))});else if(3==cities.length)$("#doublet-location-section").remove(),$("#location-section").remove(),$(".gt-info-location-1").text(cities[0].name),url="/ajax/city/get_images",postData={city_id:cities[0].id},$.post(url,postData,function(t){void 0!==t.data&&t.data.length>0&&(image_file=t.data[0],$("#triplet-location-main-image-1").css("background","url('"+image_file+"') center / cover"))}),$(".gt-info-location-2").text(cities[1].name),url="/ajax/city/get_images",postData={city_id:t.data[1].id},$.post(url,postData,function(t){void 0!==t.data&&t.data.length>0&&(image_file=t.data[0],$("#triplet-location-main-image-2").css("background","url('"+image_file+"') center / cover"))}),$(".gt-info-location-3").text(cities[2].name),url="/ajax/city/get_images",postData={city_id:t.data[2].id},$.post(url,postData,function(t){void 0!==t.data&&t.data.length>0&&(image_file=t.data[0],$("#triplet-location-main-image-3").css("background","url('"+image_file+"') center / cover"))});else if(3<cities.length){$("#triplet-location-section").remove(),$("#doublet-location-section").remove();var e=cities.length,a=cities.length%3,i="";cities.forEach(function(t,o){e-a>o?i+=getLocationHTML(4,o,t.name):2===a?i+=getLocationHTML(6,o,t.name):1===a&&(i+=getLocationHTML(12,o,t.name)),e-1>o&&(i+=getSpacerHTML())}),$("#location-section").html(i),url="/ajax/city/get_images",cities.forEach(function(t,e){postData={city_id:t.id},$.post(url,postData,function(t){void 0!==t.data&&t.data.length>0&&(image_file=t.data[0],$("#location-main-image-"+e).css("background","url('"+image_file+"') center / cover"))})})}else $("#triplet-location-section").remove(),$("#doublet-location-section").remove(),$("#location-section").remove()})):$("#location-section").remove();var r=0;if(dataExists(t.data.company_twitter)?($(".gt-info-twitter").attr("href","http://twitter.com/"+t.data.company_twitter),r++):$(".gt-info-twitter").remove(),dataExists(t.data.company_facebook)?($(".gt-info-facebook").attr("href","http://facebook.com/"+t.data.company_facebook),r++):$(".gt-info-facebook").remove(),dataExists(t.data.company_linkedin)?($(".gt-info-linkedin").attr("href","http://linkedin.com/"+t.data.company_linkedin),r++):$(".gt-info-linkedin").remove(),dataExists(t.data.company_youtube)?($(".gt-info-youtube").attr("href","http://youtube.com/"+t.data.company_youtube),r++):$(".gt-info-youtube").remove(),dataExists(t.data.company_google_plus)?($(".gt-info-gplus").attr("href","http://plus.google.com/"+t.data.company_google_plus),r++):$(".gt-info-gplus").remove(),dataExists(t.data.company_pinterest)?($(".gt-info-pinterest").attr("href","http://pinterest.com/"+t.data.company_pinterest),r++):$(".gt-info-pinterest").remove(),6>r)switch(r){case 5:$(".frontpage-social-button").css("width","20%");break;case 4:$(".frontpage-social-button").removeClass("mdl-cell--2-col"),$(".frontpage-social-button").addClass("mdl-cell--3-col");break;case 3:$(".frontpage-social-button").removeClass("mdl-cell--2-col"),$(".frontpage-social-button").removeClass("mdl-cell--2-col-phone"),$(".frontpage-social-button").addClass("mdl-cell--4-col");break;case 2:$(".frontpage-social-button").removeClass("mdl-cell--2-col"),$(".frontpage-social-button").addClass("mdl-cell--6-col");break;case 1:$(".frontpage-social-button").removeClass("mdl-cell--2-col"),$(".frontpage-social-button").removeClass("mdl-cell--2-col-phone"),$(".frontpage-social-button").addClass("mdl-cell--12-col")}dataExists(t.data.company_logo)&&$("#briefcase-or-logo").html('<img src="'+getAssetHost()+"/"+t.data.company_logo+'" width=200>'),dataExists(t.data.recruiter_profile)&&"Y"==t.data.recruiter_profile?($("#bio-button").remove(),$("#contact-button").remove(),$("#schedule-button").remove(),url="/ajax/user/get_recruiter_profile/"+t.data.user_id,$.post(url,"",handleAjaxUserGetRecruiterProfile,"json")):$("#recruiter-section").remove(),setTimeout(updateSectionPositions,500),setTimeout(updateSectionPositions,1e3),setTimeout(updateSectionPositions,5e3)}function updateSectionPositions(){var t=document.getElementById("ordered-sections"),e=[],a=["company-section","recruiter-section","location-section","doublet-location-section","triplet-location-section","image-video-section",{id:"job-description-section",position:1},{id:"social-section",position:2}];a.forEach(function(t){var a="string"==typeof t?!1:t.position,i="string"==typeof t?t:t.id,o=document.getElementById(i);elementIsPresent(o)!==!1&&(a===!1?e.push(o):e=e.slice(0,a).concat(o).concat(e.slice(a)))}),e.forEach(t.appendChild.bind(t))}function elementIsPresent(t){return null!==t&&"none"!==t.style.display}function handleAjaxRecruitingTokenGetResponsedAllowed(t){if(void 0!==t.data&&void 0!==t.data.allowed)if("false"==t.data.allowed)$(".interest-fab").hide();else{if(!addedName&&"true"==t.data.collectName){var e="<paper-input";e+='  class="name-paper-input"',e+='  label="name"',e+="  autofocus",e+='  error-message="Please input your name"',e+="  required>",e+="</paper-input>",$(".email-paper-input").after(e),addedName=!0}"true"==t.data.autoPop&&(presentedInterestPopup||setTimeout(function(){presentedInterestPopup||($(".interest-dialog").each(function(t,e){disableBackButton(),e.open(),openedInterestPopup=!0}),presentedInterestPopup=!0)},void 0!==t.data.autoPopDelay?1e3*t.data.autoPopDelay:1e4))}}function getImagesGrid(t,e){var a=$('<ul class="ImageGrid ImageGrid is-loading">'),i=0,o=function(){i++,a.masonry("layout"),i===t.length&&a.removeClass("is-loading")};return a.append('<li class="ImageGrid-itemSizer">'),t.forEach(function(t){a.append(getImageGridItem(t,e,o))}),a.masonry({itemSelector:".ImageGrid-item",columnWidth:".ImageGrid-itemSizer",percentPosition:!0,transitionDuration:"0.1s"}),a}function getImageGridItem(t,e,a){var i=new Image,o=e+"/"+t.file_name,n=$('<li class="ImageGrid-item is-loading">'),s=$('<img id="image-'+t.id+'" class="ImageGrid-image" data-src="'+o+'"/>');return i.onload=function(){a(),n.removeClass("is-loading"),s.attr("src",s.data("src")),n.append(s)},i.onerror=function(){a(),n.removeClass("is-loading").addClass("is-error")},i.src=o,n}function getLocationHTML(t,e,a){var i='<div class="mdl-card mdl-cell mdl-cell--'+t+'-col mdl-shadow--2dp link-finger"';return i+='id="location-image-grid-'+e+'">',i+='<div class="mdl-cell no-margin location-main-image" id="location-main-image-'+e+'">',i+='<div class="multi-supporting-location" id="supporting-location-'+e+'">',i+='<i class="material-icons">room</i>',i+='<i class="gt-info-location-'+e+'">'+a+"</i>",i+="</div></div></div>"}function getSpacerHTML(){return'<div class="mdl-layout-spacer"></div>'}var scope=document.querySelector('template[is="dom-bind"]'),presentedInterestPopup=!1,openedInterestPopup=!1,cities=[];scope._onTrack=function(t){},scope._onOverviewClick=function(t){$(".current-section").text("Overview"),$(".mdl-layout__drawer").removeClass("is-visible"),this.$.list.sharedElements={"fade-in":t.target,"fade-out":t.target},this.$.pages.selected=4,smallScreen()},scope._onSkillsClick=function(t){$(".current-section").text("Skills Required"),$(".mdl-layout__drawer").removeClass("is-visible"),this.$.list.sharedElements={"fade-in":t.target,"fade-out":t.target},this.$.pages.selected=4,smallScreen()},scope._onValuesClick=function(t){$(".current-section").text("Values"),$(".mdl-layout__drawer").removeClass("is-visible"),this.$.list.sharedElements={"fade-in":t.target,"fade-out":t.target},this.$.pages.selected=4,smallScreen()},scope._onResponsibilitiesClick=function(t){$(".current-section").text("Responsibilities"),$(".mdl-layout__drawer").removeClass("is-visible"),this.$.list.sharedElements={"fade-in":t.target,"fade-out":t.target},this.$.pages.selected=4,smallScreen()},scope._onPerksClick=function(t){$(".current-section").text("Perks"),$(".mdl-layout__drawer").removeClass("is-visible"),this.$.list.sharedElements={"fade-in":t.target,"fade-out":t.target},this.$.pages.selected=4,smallScreen()},scope._onLocationClick=function(t){var e=0;0===$("#location-section").length&&(e=$(t.target).is("div")?$(t.target).attr("id").slice(-1)-1:$(t.target).parents("div").attr("id").slice(-1)-1),isNaN(e)&&(e=0),handleAjaxCityGet(cities[e]),$(".mdl-layout__drawer").removeClass("is-visible"),this.$.list.sharedElements={"fade-in":t.target,"fade-out":t.target},this.$.pages.selected=1,$("google-map").resize()},scope._onImagesClick=function(t){$(".mdl-layout__drawer").removeClass("is-visible"),this.$.list.sharedElements={"fade-in":t.target,"fade-out":t.target},this.$.pages.selected=2,path=getUrlPath(),url="/ajax/recruiting_token/get_images"+path[4],$.post(url,"",function(t){void 0!==t.data&&(assetHost=getAssetHost(),images=getImagesGrid(t.data,assetHost),$("#images-container").empty().append(images))})},scope._onVideosClick=function(t){$(".mdl-layout__drawer").removeClass("is-visible"),this.$.list.sharedElements={"fade-in":t.target,"fade-out":t.target},this.$.pages.selected=3,path=getUrlPath(),url="/ajax/recruiting_token/get_videos"+path[4],$.post(url,"",function(t){if(void 0!==t.data&&t.data.length>0){var e="";$.each(t.data,function(t,a){"youtube"==a.source&&(vidUrl="https://www.youtube.com/embed/"),"vimeo"==a.source&&(vidUrl="https://player.vimeo.com/video/"),e+='<section class="section--center mdl-grid mdl-grid--no-spacing mdl-shadow--2dp">',e+='<div class="mdl-card mdl-cell mdl-cell--12-col">',e+='<div class="mdl-card__title">',e+='<iframe class="gt-info-video"',e+='  width="853"',e+='  height="480"',e+='  src="'+vidUrl+a.source_id+'"',e+='  frameborder="0" allowfullscreen>',e+="</iframe>",e+="</div>",e+="</div>",e+="</section>"}),e+='<section class="section--footer mdl-color--light-grey mdl-grid">',e+="</section>",$("#videos-container").html(e)}})},scope._onInterestClick0=function(t){$(".interest-dialog")[0].open(),presentedInterestPopup=!0,openedInterestPopup=!0,disableBackButton()},scope._onInterestClick1=function(t){$(".interest-dialog")[1].open(),presentedInterestPopup=!0,openedInterestPopup=!0,disableBackButton()},scope._onInterestClick2=function(t){$(".interest-dialog")[2].open(),presentedInterestPopup=!0,openedInterestPopup=!0,disableBackButton()},scope._onInterestClick3=function(t){$(".interest-dialog")[3].open(),presentedInterestPopup=!0,openedInterestPopup=!0,disableBackButton()},scope._onInterestClick4=function(t){$(".interest-dialog")[4].open(),presentedInterestPopup=!0,openedInterestPopup=!0,disableBackButton()},scope._submitInterest=submitInterest;var applicationLink="";scope._applyNow=function(t){""!==applicationLink?$(".email-paper-input").length?submitInterest(t):window.location.href=applicationLink:($(".apply-button").remove(),$(".interest-form").text("An error has occured forwarding you to the application."),$(".dismiss-interest-button").text("DISMISS"))},scope._closeInterestDialog=function(t){$(".interest-dialog").each(function(t,e){e.close(),openedInterestPopup=!1,enableBackButton()})},scope._closeApplyDialog=function(t){$(".apply-dialog").each(function(t,e){e.close()})},scope._onBackClick=function(t){openedInterestPopup||($(".gt-info-video").remove(),this.$.pages.selected=0)},$(document).ready(function(){loadDataAndPopulateToken(),window.onfocus=loadDataAndPopulateToken,$(document).keyup(function(t){27===t.keyCode&&($(".interest-dialog").each(function(t,e){e.close()}),openedInterestPopup=!1,enableBackButton())});var t=!0;$(document).click(function(){0===$(".iron-overlay-backdrop-0").length&&t&&(enableBackButton(),t=!t)}),$(".dismiss-interest-button, .submit-interest-button").click(function(){enableBackButton()});var e=0;closeInterestDialog(),setInterval(function(){50>=e?(0===$(".iron-overlay-backdrop-0").length&&($(".interest-dialog").each(function(t,e){e.close()}),openedInterestPopup=!1,enableBackButton()),e++):clearInterval(this)},1e3)});var addedName=!1;