...
<div class="wpb_text_column wpb_content_element   vc_custom_1429192389809">
  <div class="wpb_wrapper">
    <div class="wpb_text_column-text-style" style="">
      <div style="font-size: 17px;">
        Stop sending text filled job descriptions. Enter your email below to start adding the Sizzle to your job descriptions.
      </div>
    </div>
  </div>
</div>
...
<div class="wpcf7-response-output wpcf7-display-none"></div></form></div></div>
  ...
  <div class="vc_col-sm-8 wpb_column column_container  vc_custom_1428521940168 ">
    <div class="wpb_wrapper">
