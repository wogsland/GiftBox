                ...
                <div id="signup-form-container">
                    <form id="sizzle-signup-form" action="/ajax/signup" method="post">
                        ...
                        <div class="form-group" id="email-form-group">
                            <input type="email" class="form-control" id="sizzle1_signup_email"
                                   name="sizzle1_signup_email" placeholder="Email" autocomplete="off" required>
                        </div>
                        <div class="form-group" id="password-form-group" hidden>
                            <input type="password" class="form-control" id="sizzle1_signup_password"
                                   name="sizzle1_signup_password" placeholder="Password" autocomplete="off" required>
                        </div>
                        <?php /*
                <div class="checkbox">
                  <label>
...
<section id="what-is-sizzle">
    <div class="container">
        <div class="row">
            ...
            <div id="right-div-2" class="col-md-8 wow fadeInRight animated" data-wow-offset="10"
...
<section id="put-a-bow-on-it">
    <div class="container">
        <div class="row">
            ...
            <div id="right-div-4" class="col-md-6 wow fadeInRight animated" data-wow-offset="10"
                 data-wow-duration="1.5s">
...
<section id="analyze-and-split-test">
    <div class="container">
        <div class="row">
            ...
            <div id="right-div-5" class="col-md-4 wow fadeInRight animated" data-wow-offset="10"
                 data-wow-duration="1.5s">
