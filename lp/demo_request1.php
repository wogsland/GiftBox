      ...
      <div class="container centered-block">
        ...
        <div class="col-sm-6 col-sm-offset-3">
          <div id="call-to-action" class="heading-block align-center">
            <h2>Schedule <span class="highlight">Your Demo</span> Now</h2>
            <p class="heading-font">
              So you want to schedule a demo with Sizzle. Well, we are excited to show you what all the fuss is about.
              Enter your email below, and we will reach out to you to schedule a demo that fits into your schedule.
            </p>
          </div>
