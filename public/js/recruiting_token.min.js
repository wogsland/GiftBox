...
!function(){Polymer({is:"x-card",behaviors:[Polymer.NeonSharedElementAnimatableBehavior],properties:{animationConfig:{value:function(){return{entry:[{name:"ripple-animation",id:"ripple",toPage:this},{name:"fade-out-animation",node:this.$.placeholder,timing:{delay:250}},{name:"fade-in-animation",node:this.$.container,timing:{delay:50}}],exit:[{name:"opaque-animation",node:this.$.placeholder},{name:"fade-out-animation",node:this.$.container,timing:{duration:0}},{name:"reverse-ripple-animation",id:"reverse-ripple",fromPage:this}]}}},sharedElements:{value:function(){return{ripple:this.$.placeholder,"reverse-ripple":this.$.placeholder}}}}})}();
...
function smallScreen(){$(window).width()<739&&($(".back-button-lower").addClass("back-button-lower-right"),$(".back-button-lower-right").removeClass("back-button-lower"))}function numberWithCommas(e){return e.toString().replace(/\B(?=(\d{3})+(?!\d))/g,",")}function dataExists(e){return void 0!==e&&null!==e&&""!==e}function getUrlPath(){var e={};i=0;window.location.href.replace(/\/([a-zA-Z0-9]*)/gi,function(t){e[i]=t,i++});return e}function getAssetHost(){switch(window.location.hostname){default:return"/uploads"}}function getPosition(e,t,a){return e.split(t,a).join(t).length}var scope=document.querySelector('template[is="dom-bind"]');scope._onTrack=function(e){},scope._onOverviewClick=function(e){$(".current-section").text("Overview"),$(".mdl-layout__drawer").removeClass("is-visible"),this.$.list.sharedElements={"fade-in":e.target,"fade-out":e.target},this.$.pages.selected=7,smallScreen()},scope._onSkillsClick=function(e){$(".current-section").text("Skills Required"),$(".mdl-layout__drawer").removeClass("is-visible"),this.$.list.sharedElements={"fade-in":e.target,"fade-out":e.target},this.$.pages.selected=7,smallScreen()},scope._onValuesClick=function(e){$(".current-section").text("Values"),$(".mdl-layout__drawer").removeClass("is-visible"),this.$.list.sharedElements={"fade-in":e.target,"fade-out":e.target},this.$.pages.selected=7,smallScreen()},scope._onResponsibilitiesClick=function(e){$(".current-section").text("Responsibilities"),$(".mdl-layout__drawer").removeClass("is-visible"),this.$.list.sharedElements={"fade-in":e.target,"fade-out":e.target},this.$.pages.selected=7,smallScreen()},scope._onPerksClick=function(e){$(".current-section").text("Perks"),$(".mdl-layout__drawer").removeClass("is-visible"),this.$.list.sharedElements={"fade-in":e.target,"fade-out":e.target},this.$.pages.selected=7,smallScreen()};var cityId=1;scope._onLocationClick=function(e){$(".mdl-layout__drawer").removeClass("is-visible"),this.$.list.sharedElements={"fade-in":e.target,"fade-out":e.target},this.$.pages.selected=4,$("google-map").resize()},scope._onImagesClick=function(e){$(".mdl-layout__drawer").removeClass("is-visible"),this.$.list.sharedElements={"fade-in":e.target,"fade-out":e.target},this.$.pages.selected=5,path=getUrlPath(),url="/ajax/recruiting_token/get_images"+path[4],$.post(url,"",function(e){void 0!==e.data&&(assetHost=getAssetHost(),i=1,images="",$.each(e.data,function(e,t){i%3===1&&(images+='<section class="section--center mdl-grid mdl-grid--no-spacing">'),images+='<div id="image-'+i+'" class="demo-card-image mdl-card mdl-cell--4-col-phone mdl-shadow--2dp">',images+='<div class="mdl-card__title mdl-card--expand"></div>',images+="</div>",i%3===0?images+="</section>":images+='<div class="mdl-layout-spacer"></div>',i++}),(i-1)%3!==0&&(images+='<div class="demo-card-image mdl-card mdl-cell--4-col-phone">',images+='<div class="mdl-card__title mdl-card--expand"></div>',images+="</div>",(i-1)%3===1&&(images+='<div class="demo-card-image mdl-card mdl-cell--4-col-phone">',images+='<div class="mdl-card__title mdl-card--expand"></div>',images+="</div>"),images+="</section>"),images+='<section class="section--footer mdl-color--light-grey mdl-grid">',images+="</section>",$("#images-container").html(images),i=1,$.each(e.data,function(e,t){$("#image-"+i).css("background","url('"+assetHost+"/"+t.file_name+"') center / cover"),i++}))})},scope._onVideosClick=function(e){$(".mdl-layout__drawer").removeClass("is-visible"),this.$.list.sharedElements={"fade-in":e.target,"fade-out":e.target},this.$.pages.selected=6,path=getUrlPath(),url="/ajax/recruiting_token/get_videos"+path[4],$.post(url,"",function(e){if(void 0!==e.data&&e.data.length>0){var t="";$.each(e.data,function(e,a){"youtube"==a.source&&(vidUrl="https://www.youtube.com/embed/"),"vimeo"==a.source&&(vidUrl="https://player.vimeo.com/video/"),t+='<section class="section--center mdl-grid mdl-grid--no-spacing mdl-shadow--2dp">',t+='<div class="mdl-card mdl-cell mdl-cell--12-col">',t+='<div class="mdl-card__title">',t+='<iframe class="gt-info-video"',t+='  width="853"',t+='  height="480"',t+='  src="'+vidUrl+a.source_id+'"',t+='  frameborder="0" allowfullscreen>',t+="</iframe>",t+="</div>",t+="</div>",t+="</section>"}),t+='<section class="section--footer mdl-color--light-grey mdl-grid">',t+="</section>",$("#videos-container").html(t)}})},scope._onYesClick=function(e){$(".gt-info-video").remove(),$("#placeholder").css("background-color","green"),this.$.list.sharedElements={ripple:e.target,"reverse-ripple":e.target},this.$.pages.selected=1,$("#yes-email-form").submit(function(e){e.preventDefault()}),$("#yes-submit").click(function(e){e.preventDefault(),url="/ajax/recruiting_token_response/create"+path[4],url+="/"+encodeURIComponent($("#yes-email").val())+"/yes",$.post(url,"",function(e){void 0!==e.data.id&e.data.id>0&&$("#yes-content").text("Thanks for your interest!")},"json")})},scope._onMaybeClick=function(e){$(".gt-info-video").remove(),this.$.list.sharedElements={ripple:e.target,"reverse-ripple":e.target},this.$.pages.selected=2,$("#maybe-email-form").submit(function(e){e.preventDefault()}),$("#maybe-submit").click(function(e){e.preventDefault(),url="/ajax/recruiting_token_response/create"+path[4],url+="/"+encodeURIComponent($("#maybe-email").val())+"/maybe",$.post(url,"",function(e){void 0!==e.data.id&e.data.id>0&&$("#maybe-content").text("Thanks for your interest!")},"json")})},scope._onNoClick=function(e){$(".gt-info-video").remove(),this.$.list.sharedElements={ripple:e.target,"reverse-ripple":e.target},this.$.pages.selected=3,$("#no-email-form").submit(function(e){e.preventDefault()}),$("#no-submit").click(function(e){e.preventDefault(),url="/ajax/recruiting_token_response/create"+path[4],url+="/"+encodeURIComponent($("#no-email").val())+"/no",$.post(url,"",function(e){void 0!==e.data.id&e.data.id>0&&$("#no-content").text("Thanks for telling us. We'll take you off our list!")},"json")})},scope._onBackClick=function(e){$(".gt-info-video").remove(),this.$.pages.selected=0},$(document).ready(function(){path=getUrlPath(),"/token"===path[2]&"/recruiting"==path[3]&"undefined"!=typeof path[4]?(url="/ajax/recruiting_token/get"+path[4],$.post(url,"",function(e){"false"==e.success&&(window.location.href="https://www.gosizzle.io");var t;dataExists(e.data.company)?($(".gt-info-company").text(e.data.company),t=e.data.company+" - "+e.data.job_title):t=e.data.job_title,$("title").text(t),$(".gt-info-title").text(t),$(".gt-info-jobtitle").text(e.data.job_title),$(".gt-info-overview").html(e.data.job_description);var a=""+e.data.job_description,o=a.split(" "),s="";for(i=0;i<50;i++)void 0!==o[i]&&(s+=o[i]+" ");var l=(s.match(/<p>/g)||[]).length;l>4&&(s=s.substring(0,getPosition(s,"<p>",5))),(o.length>=50||l>4)&&(s+=" ... ",s+='<a href="#overview-section" id="read-more" class="mdl-color-text--primary-dark">read more</a>'),$(".gt-info-overview-short").html(s),dataExists(e.data.job_description)||$("#overview-section-2").hide();var n=0;if(dataExists(e.data.skills_required)?($(".gt-info-skills").html(e.data.skills_required),n++):($("#skills-button").hide(),$("#skills-section").hide(),$("#skills-section-2").hide()),dataExists(e.data.responsibilities)?($(".gt-info-responsibilities").html(e.data.responsibilities),n++):($("#responsibilities-button").hide(),$("#responsibilities-section").hide(),$("#responsibilities-section-2").hide()),dataExists(e.data.company_values)?($(".gt-info-values").html(e.data.company_values),n++):($("#values-button").hide(),$("#values-section").hide(),$("#values-section-2").hide()),dataExists(e.data.perks)?($(".gt-info-perks").html(e.data.perks),n++):($("#perks-button").hide(),$("#perks-section").hide(),$("#perks-section-2").hide()),dataExists(e.data.company_description)?$("#company-description-text").html(e.data.company_description):$("#company-description").hide(),4>n)switch(n){case 3:$(".job-description-option").removeClass("mdl-cell--3-col"),$(".job-description-option").addClass("mdl-cell--4-col");break;case 2:$(".job-description-option").removeClass("mdl-cell--3-col"),$(".job-description-option").addClass("mdl-cell--6-col");break;case 1:$(".job-description-option").removeClass("mdl-cell--3-col"),$(".job-description-option").addClass("mdl-cell--12-col")}dataExists(e.data.city_id)?(cityId=e.data.city_id,url="/ajax/city/get/"+cityId,$.post(url,"",function(e){if(void 0!==e.data.id&e.data.id>0){$(".gt-info-location").text(e.data.name);var t=numberWithCommas(e.data.population);$(".gt-city-population").text(t),$(".gt-city-timezone").text(e.data.timezone),$(".gt-city-county").text(e.data.county),$("google-map")[0].latitude=e.data.latitude,$("google-map")[0].longitude=e.data.longitude,$(".gt-city-spring-hi").text(e.data.temp_hi_spring),$(".gt-city-spring-lo").text(e.data.temp_lo_spring),$(".gt-city-spring-avg").text(e.data.temp_avg_spring),$(".gt-city-summer-hi").text(e.data.temp_hi_summer),$(".gt-city-summer-lo").text(e.data.temp_lo_summer),$(".gt-city-summer-avg").text(e.data.temp_avg_summer),$(".gt-city-fall-hi").text(e.data.temp_hi_fall),$(".gt-city-fall-lo").text(e.data.temp_lo_fall),$(".gt-city-fall-avg").text(e.data.temp_avg_fall),$(".gt-city-winter-hi").text(e.data.temp_hi_winter),$(".gt-city-winter-lo").text(e.data.temp_lo_winter),$(".gt-city-winter-avg").text(e.data.temp_avg_winter),assetHost=getAssetHost(),$("#location-frontpage").css("background","url('"+assetHost+"/"+e.data.image_file+"') center / cover"),$("#location-back").css("background","url('"+assetHost+"/"+e.data.image_file+"') center / cover")}})):$("#location-frontpage").remove();var r=0;if(dataExists(e.data.company_twitter)?($(".gt-info-twitter").attr("href","http://twitter.com/"+e.data.company_twitter),r++):$(".gt-info-twitter").remove(),dataExists(e.data.company_facebook)?($(".gt-info-facebook").attr("href","http://facebook.com/"+e.data.company_facebook),r++):$(".gt-info-facebook").remove(),dataExists(e.data.company_linkedin)?($(".gt-info-linkedin").attr("href","http://linkedin.com/"+e.data.company_linkedin),r++):$(".gt-info-linkedin").remove(),dataExists(e.data.company_youtube)?($(".gt-info-youtube").attr("href","http://youtube.com/"+e.data.company_youtube),r++):$(".gt-info-youtube").remove(),dataExists(e.data.company_google_plus)?($(".gt-info-gplus").attr("href","http://plus.google.com/"+e.data.company_google_plus),r++):$(".gt-info-gplus").remove(),dataExists(e.data.company_pinterest)?($(".gt-info-pinterest").attr("href","http://pinterest.com/"+e.data.company_pinterest),r++):$(".gt-info-pinterest").remove(),6>r)switch(r){case 5:$(".frontpage-social-button").css("width","20%");break;case 4:$(".frontpage-social-button").removeClass("mdl-cell--2-col"),$(".frontpage-social-button").addClass("mdl-cell--3-col");break;case 3:$(".frontpage-social-button").removeClass("mdl-cell--2-col"),$(".frontpage-social-button").removeClass("mdl-cell--2-col-phone"),$(".frontpage-social-button").addClass("mdl-cell--4-col");break;case 2:$(".frontpage-social-button").removeClass("mdl-cell--2-col"),$(".frontpage-social-button").addClass("mdl-cell--6-col");break;case 1:$(".frontpage-social-button").removeClass("mdl-cell--2-col"),$(".frontpage-social-button").removeClass("mdl-cell--2-col-phone"),$(".frontpage-social-button").addClass("mdl-cell--12-col")}dataExists(e.data.company_logo)&&$("#briefcase-or-logo").html('<img src="'+getAssetHost()+"/"+e.data.company_logo+'" width=200>'),dataExists(e.data.recruiter_profile)&&"Y"==e.data.recruiter_profile?($("#bio-button").remove(),$("#contact-button").remove(),$("#schedule-button").remove(),url="/ajax/user/get_recruiter_profile/"+e.data.user_id,$.post(url,"",function(e){void 0!==e.data?(assetHost=getAssetHost(),dataExists(e.data.face_image)&&($("#icon-or-face").remove(),$("#recruiter-face").css("background",'url("'+assetHost+"/"+e.data.face_image+'") 50% 50% / cover')),dataExists(e.data.position)?$("#gt-info-recruiter-position").html(e.data.position):$("#gt-info-recruiter-position").remove(),dataExists(e.data.about)?$("#gt-info-recruiter-bio").html(e.data.about):$("#gt-info-recruiter-bio").remove(),dataExists(e.data.linkedin)?($("#linkedin-button").attr("href",e.data.linkedin),$(".recruiter-profile-option").removeClass("mdl-cell--3-col"),$(".recruiter-profile-option").addClass("mdl-cell--12-col")):$("#linkedin-button").remove(),dataExists(e.data.first_name)||dataExists(e.data.last_name)?$("#gt-info-recruiter-name").html(e.data.first_name+" "+e.data.last_name):$("#recruiter-section").remove()):$("#recruiter-section").remove()},"json")):$("#recruiter-section").remove()},"json"),url="/ajax/recruiting_token/get_images"+path[4],$.post(url,"",function(e){void 0!==e.data&&e.data.length>0?(assetHost=getAssetHost(),e.data.length>0?($("#images-frontpage").hide(),$("#company-main-image").css("background","url('"+assetHost+"/"+e.data[0].file_name+"') center / cover"),$(window).width()<739||e.data.length<4?($("#company-secondary-images").remove(),$("#company-image-grid").css("width","100%"),$("#company-main-image").css("width","100%")):($("#company-secondary-image-1").attr("src",assetHost+"/"+e.data[1].file_name),$("#company-secondary-image-2").attr("src",assetHost+"/"+e.data[2].file_name),$("#company-secondary-image-3").attr("src",assetHost+"/"+e.data[3].file_name)),$("#videos-frontpage").removeClass("mdl-cell--6-col"),$("#videos-frontpage").addClass("mdl-cell--12-col")):($("#company-section").hide(),$("#images-frontpage").css("background","url('"+assetHost+"/"+e.data[0].file_name+"') center / cover"))):($("#company-section").hide(),$("#images-frontpage").hide(),$("#videos-frontpage").removeClass("mdl-cell--6-col"),$("#videos-frontpage").addClass("mdl-cell--12-col"))}),url="/ajax/recruiting_token/get_responses_allowed"+path[4],$.post(url,"",function(e){void 0!==e.data&&void 0!==e.data.allowed&&"false"==e.data.allowed&&$("#interested-row").hide()}),url="/ajax/recruiting_token/get_videos"+path[4],$.post(url,"",function(e){if(void 0!==e.data&&e.data.length>0){var t=e.data[0].source_id;"youtube"==e.data[0].source&&(vidUrl="https://i.ytimg.com/vi/"+t+"/hqdefault.jpg",$("#videos-frontpage").css("background","url('"+vidUrl+"') center / cover")),"vimeo"==e.data[0].source&&$.getJSON("https://vimeo.com/api/v2/video/"+t+".json",function(e){$("#videos-frontpage").css("background","url('"+e[0].thumbnail_large+"') center / cover")})}else $("#videos-frontpage").hide(),$("#images-frontpage").removeClass("mdl-cell--6-col"),$("#images-frontpage").addClass("mdl-cell--12-col")})):window.location.href="https://www.gosizzle.io",smallScreen()});