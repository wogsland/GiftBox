...
function smallScreen(){$(window).width()<739&&($(".back-button-lower").addClass("back-button-lower-right"),$(".back-button-lower-right").removeClass("back-button-lower"))}function numberWithCommas(t){return t.toString().replace(/\B(?=(\d{3})+(?!\d))/g,",")}function dataExists(t){return void 0!==t&&null!==t&&""!==t}function getUrlPath(){var t={};i=0;window.location.href.replace(/\/([a-zA-Z0-9]*)/gi,function(e){t[i]=e,i++});return t}function getAssetHost(){switch(window.location.hostname){default:return"/uploads"}}function getPosition(t,e,a){return t.split(e,a).join(e).length}var scope=document.querySelector('template[is="dom-bind"]');scope._onTrack=function(t){},scope._onOverviewClick=function(t){$(".current-section").text("Overview"),$(".mdl-layout__drawer").removeClass("is-visible"),this.$.list.sharedElements={"fade-in":t.target,"fade-out":t.target},this.$.pages.selected=7,smallScreen()},scope._onSkillsClick=function(t){$(".current-section").text("Skills Required"),$(".mdl-layout__drawer").removeClass("is-visible"),this.$.list.sharedElements={"fade-in":t.target,"fade-out":t.target},this.$.pages.selected=7,smallScreen()},scope._onValuesClick=function(t){$(".current-section").text("Values"),$(".mdl-layout__drawer").removeClass("is-visible"),this.$.list.sharedElements={"fade-in":t.target,"fade-out":t.target},this.$.pages.selected=7,smallScreen()},scope._onResponsibilitiesClick=function(t){$(".current-section").text("Responsibilities"),$(".mdl-layout__drawer").removeClass("is-visible"),this.$.list.sharedElements={"fade-in":t.target,"fade-out":t.target},this.$.pages.selected=7,smallScreen()},scope._onPerksClick=function(t){$(".current-section").text("Perks"),$(".mdl-layout__drawer").removeClass("is-visible"),this.$.list.sharedElements={"fade-in":t.target,"fade-out":t.target},this.$.pages.selected=7,smallScreen()};var cityId=1;scope._onLocationClick=function(t){$(".mdl-layout__drawer").removeClass("is-visible"),this.$.list.sharedElements={"fade-in":t.target,"fade-out":t.target},this.$.pages.selected=4,$("google-map").resize()},scope._onImagesClick=function(t){$(".mdl-layout__drawer").removeClass("is-visible"),this.$.list.sharedElements={"fade-in":t.target,"fade-out":t.target},this.$.pages.selected=5,path=getUrlPath(),url="/ajax/recruiting_token/get_images"+path[4],$.post(url,"",function(t){void 0!==t.data&&(assetHost=getAssetHost(),i=1,images="",$.each(t.data,function(t,e){i%3===1&&(images+='<section class="section--center mdl-grid mdl-grid--no-spacing">'),images+='<div id="image-'+i+'" class="demo-card-image mdl-card mdl-cell--4-col-phone mdl-shadow--2dp">',images+='<div class="mdl-card__title mdl-card--expand"></div>',images+="</div>",i%3===0?images+="</section>":images+='<div class="mdl-layout-spacer"></div>',i++}),(i-1)%3!==0&&(images+='<div class="demo-card-image mdl-card mdl-cell--4-col-phone">',images+='<div class="mdl-card__title mdl-card--expand"></div>',images+="</div>",(i-1)%3===1&&(images+='<div class="demo-card-image mdl-card mdl-cell--4-col-phone">',images+='<div class="mdl-card__title mdl-card--expand"></div>',images+="</div>"),images+="</section>"),images+='<section class="section--footer mdl-color--light-grey mdl-grid">',images+="</section>",$("#images-container").html(images),i=1,$.each(t.data,function(t,e){$("#image-"+i).css("background","url('"+assetHost+"/"+e.file_name+"') center / cover"),i++}))})},scope._onVideosClick=function(t){$(".mdl-layout__drawer").removeClass("is-visible"),this.$.list.sharedElements={"fade-in":t.target,"fade-out":t.target},this.$.pages.selected=6,path=getUrlPath(),url="/ajax/recruiting_token/get_videos"+path[4],$.post(url,"",function(t){if(void 0!==t.data&&t.data.length>0){var e="";$.each(t.data,function(t,a){"youtube"==a.source&&(vidUrl="https://www.youtube.com/embed/"),"vimeo"==a.source&&(vidUrl="https://player.vimeo.com/video/"),e+='<section class="section--center mdl-grid mdl-grid--no-spacing mdl-shadow--2dp">',e+='<div class="mdl-card mdl-cell mdl-cell--12-col">',e+='<div class="mdl-card__title">',e+='<iframe class="gt-info-video"',e+='  width="853"',e+='  height="480"',e+='  src="'+vidUrl+a.source_id+'"',e+='  frameborder="0" allowfullscreen>',e+="</iframe>",e+="</div>",e+="</div>",e+="</section>"}),e+='<section class="section--footer mdl-color--light-grey mdl-grid">',e+="</section>",$("#videos-container").html(e)}})},scope._onYesClick=function(t){$(".gt-info-video").remove(),$("#placeholder").css("background-color","green"),this.$.list.sharedElements={ripple:t.target,"reverse-ripple":t.target},this.$.pages.selected=1,$("#yes-email-form").submit(function(t){t.preventDefault()}),$("#yes-submit").click(function(t){t.preventDefault(),url="/ajax/recruiting_token_response/create"+path[4],url+="/"+encodeURIComponent($("#yes-email").val())+"/yes",$.post(url,"",function(t){void 0!==t.data.id&t.data.id>0&&$("#yes-content").text("Thanks for your interest!")},"json")})},scope._onMaybeClick=function(t){$(".gt-info-video").remove(),this.$.list.sharedElements={ripple:t.target,"reverse-ripple":t.target},this.$.pages.selected=2,$("#maybe-email-form").submit(function(t){t.preventDefault()}),$("#maybe-submit").click(function(t){t.preventDefault(),url="/ajax/recruiting_token_response/create"+path[4],url+="/"+encodeURIComponent($("#maybe-email").val())+"/maybe",$.post(url,"",function(t){void 0!==t.data.id&t.data.id>0&&$("#maybe-content").text("Thanks for your interest!")},"json")})},scope._onNoClick=function(t){$(".gt-info-video").remove(),this.$.list.sharedElements={ripple:t.target,"reverse-ripple":t.target},this.$.pages.selected=3,$("#no-email-form").submit(function(t){t.preventDefault()}),$("#no-submit").click(function(t){t.preventDefault(),url="/ajax/recruiting_token_response/create"+path[4],url+="/"+encodeURIComponent($("#no-email").val())+"/no",$.post(url,"",function(t){void 0!==t.data.id&t.data.id>0&&$("#no-content").text("Thanks for telling us. We'll take you off our list!")},"json")})},scope._onBackClick=function(t){$(".gt-info-video").remove(),this.$.pages.selected=0},$(document).ready(function(){path=getUrlPath(),"/token"===path[2]&"/recruiting"==path[3]&"undefined"!=typeof path[4]?(url="/ajax/recruiting_token/get"+path[4],$.post(url,"",function(t){"false"==t.success&&(window.location.href="https://www.gosizzle.io");var e;dataExists(t.data.company)?($(".gt-info-company").text(t.data.company),e=t.data.company+" - "+t.data.job_title):e=t.data.job_title,$("title").text(e),$(".gt-info-title").text(e),$(".gt-info-jobtitle").text(t.data.job_title),$(".gt-info-overview").html(t.data.job_description);var a=""+t.data.job_description,o=a.split(" "),s="";for(i=0;i<50;i++)void 0!==o[i]&&(s+=o[i]+" ");var l=(s.match(/<p>/g)||[]).length;l>4&&(s=s.substring(0,getPosition(s,"<p>",5))),(o.length>=50||l>4)&&(s+=" ... ",s+='<a href="#overview-section" id="read-more" class="mdl-color-text--primary-dark">read more</a>'),$(".gt-info-overview-short").html(s),dataExists(t.data.job_description)||$("#overview-section-2").hide();var n=0;if(dataExists(t.data.skills_required)?($(".gt-info-skills").html(t.data.skills_required),n++):($("#skills-button").hide(),$("#skills-section").hide(),$("#skills-section-2").hide()),dataExists(t.data.responsibilities)?($(".gt-info-responsibilities").html(t.data.responsibilities),n++):($("#responsibilities-button").hide(),$("#responsibilities-section").hide(),$("#responsibilities-section-2").hide()),dataExists(t.data.company_values)?($(".gt-info-values").html(t.data.company_values),n++):($("#values-button").hide(),$("#values-section").hide(),$("#values-section-2").hide()),dataExists(t.data.perks)?($(".gt-info-perks").html(t.data.perks),n++):($("#perks-button").hide(),$("#perks-section").hide(),$("#perks-section-2").hide()),dataExists(t.data.company_description)?$("#company-description-text").html(t.data.company_description):$("#company-description").hide(),4>n)switch(n){case 3:$(".job-description-option").removeClass("mdl-cell--3-col"),$(".job-description-option").addClass("mdl-cell--4-col");break;case 2:$(".job-description-option").removeClass("mdl-cell--3-col"),$(".job-description-option").addClass("mdl-cell--6-col");break;case 1:$(".job-description-option").removeClass("mdl-cell--3-col"),$(".job-description-option").addClass("mdl-cell--12-col")}dataExists(t.data.city_id)?(cityId=t.data.city_id,url="/ajax/city/get/"+cityId,$.post(url,"",function(t){if(void 0!==t.data.id&t.data.id>0){$(".gt-info-location").text(t.data.name);var e=numberWithCommas(t.data.population);$(".gt-city-population").text(e),$(".gt-city-timezone").text(t.data.timezone),$(".gt-city-county").text(t.data.county),$("google-map")[0].latitude=t.data.latitude,$("google-map")[0].longitude=t.data.longitude,$(".gt-city-spring-hi").text(t.data.temp_hi_spring),$(".gt-city-spring-lo").text(t.data.temp_lo_spring),$(".gt-city-spring-avg").text(t.data.temp_avg_spring),$(".gt-city-summer-hi").text(t.data.temp_hi_summer),$(".gt-city-summer-lo").text(t.data.temp_lo_summer),$(".gt-city-summer-avg").text(t.data.temp_avg_summer),$(".gt-city-fall-hi").text(t.data.temp_hi_fall),$(".gt-city-fall-lo").text(t.data.temp_lo_fall),$(".gt-city-fall-avg").text(t.data.temp_avg_fall),$(".gt-city-winter-hi").text(t.data.temp_hi_winter),$(".gt-city-winter-lo").text(t.data.temp_lo_winter),$(".gt-city-winter-avg").text(t.data.temp_avg_winter),assetHost=getAssetHost(),$("#location-frontpage").css("background","url('"+assetHost+"/"+t.data.image_file+"') center / cover"),$("#location-back").css("background","url('"+assetHost+"/"+t.data.image_file+"') center / cover")}})):$("#location-frontpage").remove();var r=0;if(dataExists(t.data.company_twitter)?($(".gt-info-twitter").attr("href","http://twitter.com/"+t.data.company_twitter),r++):$(".gt-info-twitter").remove(),dataExists(t.data.company_facebook)?($(".gt-info-facebook").attr("href","http://facebook.com/"+t.data.company_facebook),r++):$(".gt-info-facebook").remove(),dataExists(t.data.company_linkedin)?($(".gt-info-linkedin").attr("href","http://linkedin.com/"+t.data.company_linkedin),r++):$(".gt-info-linkedin").remove(),dataExists(t.data.company_youtube)?($(".gt-info-youtube").attr("href","http://youtube.com/"+t.data.company_youtube),r++):$(".gt-info-youtube").remove(),dataExists(t.data.company_google_plus)?($(".gt-info-gplus").attr("href","http://plus.google.com/"+t.data.company_google_plus),r++):$(".gt-info-gplus").remove(),dataExists(t.data.company_pinterest)?($(".gt-info-pinterest").attr("href","http://pinterest.com/"+t.data.company_pinterest),r++):$(".gt-info-pinterest").remove(),6>r)switch(r){case 5:$(".frontpage-social-button").css("width","20%");break;case 4:$(".frontpage-social-button").removeClass("mdl-cell--2-col"),$(".frontpage-social-button").addClass("mdl-cell--3-col");break;case 3:$(".frontpage-social-button").removeClass("mdl-cell--2-col"),$(".frontpage-social-button").removeClass("mdl-cell--2-col-phone"),$(".frontpage-social-button").addClass("mdl-cell--4-col");break;case 2:$(".frontpage-social-button").removeClass("mdl-cell--2-col"),$(".frontpage-social-button").addClass("mdl-cell--6-col");break;case 1:$(".frontpage-social-button").removeClass("mdl-cell--2-col"),$(".frontpage-social-button").removeClass("mdl-cell--2-col-phone"),$(".frontpage-social-button").addClass("mdl-cell--12-col")}dataExists(t.data.company_logo)&&$("#briefcase-or-logo").html('<img src="'+getAssetHost()+"/"+t.data.company_logo+'" width=200>'),dataExists(t.data.recruiter_profile)&&"Y"==t.data.recruiter_profile?($("#bio-button").remove(),$("#contact-button").remove(),$("#schedule-button").remove(),url="/ajax/user/get_recruiter_profile/"+t.data.user_id,$.post(url,"",function(t){void 0!==t.data?(assetHost=getAssetHost(),dataExists(t.data.face_image)&&$("#icon-or-face").html('<img src="'+assetHost+"/"+t.data.face_image+'" width=200>'),void 0!==t.data.position&&t.data.position.length>0?$("#gt-info-recruiter-position").html(t.data.position):$("#gt-info-recruiter-position").remove(),void 0!==t.data.about&&t.data.about.length>0?$("#gt-info-recruiter-bio").html(t.data.about):$("#gt-info-recruiter-bio").remove(),void 0!==t.data.linkedin&&t.data.linkedin.length>0?$("#linkedin-button").attr("href",t.data.linkedin):$("#linkedin-button").remove(),void 0!==t.data.first_name||void 0!==t.data.last_name?$("#gt-info-recruiter-name").html(t.data.first_name+" "+t.data.last_name):$("#recruiter-section").remove()):$("#recruiter-section").remove()},"json")):$("#recruiter-section").remove()},"json"),url="/ajax/recruiting_token/get_images"+path[4],$.post(url,"",function(t){void 0!==t.data&&t.data.length>0?(assetHost=getAssetHost(),t.data.length>0?($("#images-frontpage").hide(),$("#company-main-image").css("background","url('"+assetHost+"/"+t.data[0].file_name+"') center / cover"),$(window).width()<739||t.data.length<4?($("#company-secondary-images").remove(),$("#company-image-grid").css("width","100%"),$("#company-main-image").css("width","100%")):($("#company-secondary-image-1").attr("src",assetHost+"/"+t.data[1].file_name),$("#company-secondary-image-2").attr("src",assetHost+"/"+t.data[2].file_name),$("#company-secondary-image-3").attr("src",assetHost+"/"+t.data[3].file_name)),$("#videos-frontpage").removeClass("mdl-cell--6-col"),$("#videos-frontpage").addClass("mdl-cell--12-col")):($("#company-section").hide(),$("#images-frontpage").css("background","url('"+assetHost+"/"+t.data[0].file_name+"') center / cover"))):($("#company-section").hide(),$("#images-frontpage").hide(),$("#videos-frontpage").removeClass("mdl-cell--6-col"),$("#videos-frontpage").addClass("mdl-cell--12-col"))}),url="/ajax/recruiting_token/get_responses_allowed"+path[4],$.post(url,"",function(t){void 0!==t.data&&void 0!==t.data.allowed&&"false"==t.data.allowed&&$("#interested-row").hide()}),url="/ajax/recruiting_token/get_videos"+path[4],$.post(url,"",function(t){if(void 0!==t.data&&t.data.length>0){var e=t.data[0].source_id;"youtube"==t.data[0].source&&(vidUrl="https://i.ytimg.com/vi/"+e+"/hqdefault.jpg",$("#videos-frontpage").css("background","url('"+vidUrl+"') center / cover")),"vimeo"==t.data[0].source&&$.getJSON("https://vimeo.com/api/v2/video/"+e+".json",function(t){$("#videos-frontpage").css("background","url('"+t[0].thumbnail_large+"') center / cover")})}else $("#videos-frontpage").hide(),$("#images-frontpage").removeClass("mdl-cell--6-col"),$("#images-frontpage").addClass("mdl-cell--12-col")})):window.location.href="https://www.gosizzle.io",smallScreen()});